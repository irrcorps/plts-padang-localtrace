...
<main class="dashboard-page">
    <div class="container py-5">
        ...
        <div class="dashboard-welcome mb-4 d-flex flex-wrap justify-content-between align-items-center gap-3">
            <div>
                <span class="badge-pill mb-2"><i class="bi bi-shop me-1"></i>Retailer</span>
                <h3 class="fw-bold mb-1">Halo, <?= e($user['name']) ?> 👋</h3>
                <p class="text-muted-plts mb-0">Catat penerimaan produk (retail receiving) pada traceability log.</p>
            </div>
        ...
        <div class="row g-3 mb-4">
            <div class="col-6 col-md-3">
                <div class="stat-card">
                    <div class="stat-card-icon stat-card-icon-blue"><i class="bi bi-shop-window"></i></div>
        ...
        <div class="plts-panel">
            <div class="d-flex justify-content-between align-items-center p-3 pb-0">
                <h6 class="fw-bold mb-0">Aktivitas Penerimaan Terbaru</h6>
                ...
                <table class="table plts-table align-middle mb-0">
                    ...
                    <tbody>
                        <?php if (empty($recentActivities)): ?>
                            <tr><td colspan="4" class="text-center text-muted-plts py-4">Belum ada aktivitas penerimaan yang dicatat.</td></tr>
                        <?php else: ?>
